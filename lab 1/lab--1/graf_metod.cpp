...
the method checks whether the graph is connected, if so then in change val the minimum skeleton tree of the previous graph is written down if not connected then the user is deduced this information
*/
